...
if not defined EXTERNAL_LLM_MODEL set "EXTERNAL_LLM_MODEL=gpt-4o-mini"
if not defined EXTERNAL_LLM_BASE_URL set "EXTERNAL_LLM_BASE_URL=https://api.openai.com/v1"
